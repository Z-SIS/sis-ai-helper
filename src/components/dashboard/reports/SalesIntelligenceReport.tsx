  ...
  return (
    <div className="space-y-8">
      ...
      <div className="text-center text-sm text-muted-foreground">
        <p>Last updated: {data.lastUpdated ? new Date(data.lastUpdated).toLocaleDateString() : 'Not available'}</p>
<<<<<<< HEAD
        <p className="mt-1">Generated by SSS Sales Intelligence Platform</p>
=======

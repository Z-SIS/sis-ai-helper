...
function getRecommendations(config: any, connectionStatus: string, tablesExist: boolean) {
  ...
  if (!config.hasUrl) {
    recommendations.push({
      ...
      description: 'Set NEXT_PUBLIC_SUPABASE_URL in your environment variables'
    })
  }
  ...
  if (!config.hasAnonKey) {
    recommendations.push({
      ...
      description: 'Set NEXT_PUBLIC_SUPABASE_ANON_KEY in your environment variables'
    })
  }
  ...
  if (!config.hasServiceKey) {
    recommendations.push({
      ...
      description: 'Set SUPABASE_SERVICE_ROLE_KEY for server-side operations'
    })
  }

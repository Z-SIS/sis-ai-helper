              ...
              <div key={api.name} className="border rounded-lg p-4 space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Button 
                      variant="ghost" 
                      size="sm"
                      onClick={() => testIndividualApi(api.name)}
                    >
                      Test
                    </Button>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                  <div>
                    ...
                    <p className="text-muted-foreground">{api.message}</p>
                  </div>
                  <div>
                    <span className="font-medium">Environments:</span>
                    <p className="text-muted-foreground">{api.environments.join(', ')}</p>
                  </div>
                  <div>
                    <span className="font-medium">Last Checked:</span>
                    <p className="text-muted-foreground">{api.lastChecked || 'Never'}</p>
                  </div>
                </div>
                ...
                {api.testResult && (
                  <div className="bg-muted/50 rounded p-3 text-sm">
                    ...
                    <p className="text-muted-foreground">{api.testResult.message}</p>
                    {api.testResult.responseTime && (
                      <p className="text-xs text-muted-foreground mt-1">
                        Response time: {api.testResult.responseTime}ms
                      </p>
                    )}
                  </div>
                )}

...
export function SlideTemplateForm() {
  ...
  const downloadAsMarkdown = () => {
    ...
    markdown += `**Subtitle:** ${result.subtitle}\n`;
    markdown += `**Audience:** ${result.audience}\n`;
    markdown += `**Purpose:** ${result.purpose}\n`;
    markdown += `**Estimated Duration:** ${result.estimatedDuration}\n\n`;
    markdown += `## Slides\n\n`;
    ...
    a.href = url;
    a.download = `${result.title.replace(/\s+/g, '_')}_Presentation.md`;

...
<<<<<<< HEAD
      ...
      {
        title: 'SIS Limited - Corporate Information & Leadership',
        url: 'https://www.sisindia.com/investor-relations',
        content: 'SIS Limited (NSE: SIS) is a market leader in security, facility management & cash logistics services. Board includes: Rituraj Sinha (CEO & Managing Director), Rajiv Mehrotra (CFO), Uday Sinha (Whole-time Director). Founded 1985, headquartered in Delhi NCR with operations across 28 states.',
        score: 0.92
      },
      {
        title: 'SIS Group Market Leadership & Competition',
        url: 'https://economictimes.indiatimes.com/sis-group-enterprises',
        content: 'SIS Group dominates Indian security market with 40% market share. Key competitors: G4S India, Securitas India, TOPSGRUP. Recent expansion into fintech with cash management solutions and digital security services. Revenue growth: 25% YoY in 2023-24.',
        score: 0.88
      },
      {
        title: 'SIS Limited Financial Results Q2 2024',
        url: 'https://www.bseindia.com/stock-price-quote/sis/sis-ltd',
        content: 'SIS Limited Q2 2024 results: Revenue ₹3,200 crore ($385 million), profit ₹180 crore ($22 million). Market cap ₹15,000 crore ($1.8 billion). Key clients: ICICI Bank, HDFC Bank, Reliance Retail, Future Group, government agencies. Expansion plans in Southeast Asia.',
        score: 0.85
      },
      {
        title: 'SIS Group Recent News & Strategic Initiatives',
